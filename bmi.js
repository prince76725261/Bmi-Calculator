function calculatebmi(){
    ...
    document.getElementById('bmi-output').innerHTML=bmi.toFixed(2)
        ...
        document.getElementById('message3').innerHTML="Meal 3:- 1 slice of brown bread+ 100gm of fish + 200gm of vegetables,15gm(uncooked) dal,50gm(uncooked) rice , 200gm curd ."
        document.getElementById('message4').innerHTML="Meal 4:-150gm of fruit except banana + 1 slice of bread + 150gm of fish"
        document.getElementById('message5').innerHTML="Meal 5:- 200gm of boiled vegetables,15(uncooked)dal,50gm(uncooked) rice,200gm curd."
        document.getElementById('message6').innerHTML="</br></br>You must follow these exercises to get fit:-"
    ...
    document.getElementById('bmi-output').innerHTML=bmi.toFixed(2)
        ...
        document.getElementById('message2').innerHTML="Meal 2:-150gm of any fruit,50gm of nuts (cashew and almonds)."
